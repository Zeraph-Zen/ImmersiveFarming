...
public class SprinklerRenderer extends IEBlockEntityRenderer<SprinklerBlockEntity>
{
	...
	@Override
	public void render(SprinklerBlockEntity sprinkler, float partialTicks, PoseStack matrixStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn)
	{
